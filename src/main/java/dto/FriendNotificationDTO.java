...
/**
 * DTO for friend request notification
 */
public class FriendNotificationDTO {
    ...
    public FriendNotificationDTO(String id, String type, Long fromUserId, String fromUsername, String message, String timestamp) {
        this.id = id;
        this.type = type;
